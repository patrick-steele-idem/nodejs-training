...
$rmod.def("/jquery@2.1.0/dist/jquery", function(require, exports, module, __filename, __dirname) { /*!
...
$rmod.def("/raptor-widgets@0.2.0-beta/lib/raptor-widgets", function(require, exports, module, __filename, __dirname) { /*
...
$rmod.def("/raptor-widgets@0.2.0-beta/lib/WidgetsContext", function(require, exports, module, __filename, __dirname) { 'use strict';
...
$rmod.def("/raptor-widgets@0.2.0-beta/lib/WidgetDef", function(require, exports, module, __filename, __dirname) { 'use strict';
var extend = require('raptor-util').extend;
...
$rmod.def("/raptor-util@0.2.0-beta/lib/raptor-util", function(require, exports, module, __filename, __dirname) { var slice = [].slice; 
...
$rmod.dep("/$/raptor-widgets", "raptor-util", "0.2.0-beta");
$rmod.main("/raptor-util@0.2.0-beta", "lib/raptor-util");
$rmod.def("/raptor-pubsub@0.2.0-beta/lib/index", function(require, exports, module, __filename, __dirname) { var g = typeof window === 'undefined' ? global : window;
// Make this module a true singleton
module.exports = g.__RAPTOR_PUBSUB || (g.__RAPTOR_PUBSUB = require('./raptor-pubsub')); });
$rmod.def("/raptor-pubsub@0.2.0-beta/lib/raptor-pubsub", function(require, exports, module, __filename, __dirname) { /*
 * Copyright 2011 eBay Software Foundation
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
$rmod.def("/raptor-listeners@0.2.0-beta/lib/raptor-listeners", function(require, exports, module, __filename, __dirname) { /*
 * Copyright 2011 eBay Software Foundation
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
$rmod.dep("/$/raptor-widgets/$/raptor-pubsub/$/raptor-listeners", "raptor-util", "0.2.0-beta");
$rmod.dep("/$/raptor-widgets/$/raptor-pubsub", "raptor-listeners", "0.2.0-beta");
$rmod.main("/raptor-listeners@0.2.0-beta", "lib/raptor-listeners");
$rmod.dep("/$/raptor-widgets/$/raptor-pubsub", "raptor-util", "0.2.0-beta");
$rmod.main("/raptor-pubsub@0.2.0-beta", "lib/index");
$rmod.dep("/$/raptor-widgets", "raptor-pubsub", "0.2.0-beta");
$rmod.def("/raptor-widgets@0.2.0-beta/lib/raptor-widgets_browser", function(require, exports, module, __filename, __dirname) { /*
 * Copyright 2011 eBay Software Foundation
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
$rmod.main("/raptor-widgets@0.2.0-beta/lib", "raptor-widgets");
$rmod.dep("", "raptor-widgets", "0.2.0-beta");
$rmod.def("/raptor-logging@0.2.0-beta/lib/index", function(require, exports, module, __filename, __dirname) { var g = typeof window === 'undefined' ? global : window;
// Make this module a true singleton
module.exports = g.__RAPTOR_LOGGING || (g.__RAPTOR_LOGGING = require('./raptor-logging')); });
$rmod.def("/raptor-logging@0.2.0-beta/lib/raptor-logging_stubs", function(require, exports, module, __filename, __dirname) { /*
 * Copyright 2011 eBay Software Foundation
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
$rmod.dep("", "raptor-logging", "0.2.0-beta");
$rmod.remap("/raptor-logging@0.2.0-beta/lib/raptor-logging", "raptor-logging_stubs");
$rmod.main("/raptor-logging@0.2.0-beta", "lib/index");
$rmod.def("/raptor-widgets@0.2.0-beta/lib/Widget", function(require, exports, module, __filename, __dirname) { /*
 * Copyright 2011 eBay Software Foundation
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
$rmod.dep("/$/raptor-widgets/$/raptor-listeners", "raptor-util", "0.2.0-beta");
$rmod.dep("/$/raptor-widgets", "raptor-listeners", "0.2.0-beta");
$rmod.def("/raptor-dom@0.2.0-beta/lib/raptor-dom", function(require, exports, module, __filename, __dirname) { 'use strict';
...
module.exports = dom; });
$rmod.def("/raptor-dom@0.2.0-beta/lib/raptor-dom_documentReady", function(require, exports, module, __filename, __dirname) { /*
...
$rmod.dep("/$/raptor-widgets", "raptor-dom", "0.2.0-beta");
$rmod.main("/raptor-dom@0.2.0-beta", "lib/raptor-dom");
$rmod.main("/raptor-widgets@0.2.0-beta", "lib/raptor-widgets");
$rmod.def("/raptor-widgets@0.2.0-beta/lib/WidgetsContext_browser", function(require, exports, module, __filename, __dirname) { 'use strict';
module.exports = {
...
$rmod.def("/src/components/button/widget", function(require, exports, module, __filename, __dirname) { function Widget(widgetConfig) {
